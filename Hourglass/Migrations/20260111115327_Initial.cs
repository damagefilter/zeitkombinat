...
namespace Hourglass.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceMarker = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", nullable: false),
                    HyperLink = table.Column<string>(type: "TEXT", nullable: false),
                    EstimatedHours = table.Column<TimeSpan>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HourlyRateOverride = table.Column<decimal>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceTasks_Tasks_TaskItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkSessions_Tasks_TaskItemId",
                        column: x => x.TaskItemId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceTasks_TaskItemId",
                table: "InvoiceTasks",
                column: "TaskItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkSessions_TaskItemId",
                table: "WorkSessions",
                column: "TaskItemId");
        }
